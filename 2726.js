...
// The Calculator class constructor should accept a number which serves as the 
// initial value of result.
//
// Your Calculator class should have the following methods:
//
// - add - This method adds the given number value to the result and returns 
...
//   returns the updated Calculator. If the passed value is 0, an error 
//   "Division by zero is not allowed" should be thrown.
// - power - This method raises the result to the power of the given number 
